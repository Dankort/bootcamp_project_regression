...
-- Droping the 'date' column from the table
...
-- checking if  there any correlation between the columns condition and grade? 
...
-- So usisng sub-queries I wrote a query to show them the list of such properties. 
